...
const Requests = () => {
  ...
  const changeStatusFunction = async(status,_id) => {
    try {
        ...
        >
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <div className="flex gap-3 mt-4 flex-wrap justify-center sm:justify-start">
              <button className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition" onClick={() => {
                changeStatusFunction("accept",user._id);
              }}>
                Accept
              </button>
              <button className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition" onClick={() => {
                changeStatusFunction("reject", user._id);
              }}>
                Reject
              </button>
            </div>
